...
import '../../data/mock_barbieri.dart';
...
class ConfirmSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Lo passiamo solo per assecondare il Router, la prossima schermata non lo userà!
    ...
    return Container(
      ...
      child: ElevatedButton(
        ...
        child: const Text('Conferma Orario', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
      ),
    );
  }
}